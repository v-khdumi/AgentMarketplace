...
param packageUri string = 'https://raw.githubusercontent.com/v-khdumi/AgentMarketplace/6782b59/release/agent-marketplace-linux.zip'
...
resource appSettings 'Microsoft.Web/sites/config@2023-12-01' = {
  ...
  properties: {
    ...
    DEMO_TENANT_ID: 'agent-marketplace-demo-contoso-v1'
    SEED_EXAMPLES: 'true'
